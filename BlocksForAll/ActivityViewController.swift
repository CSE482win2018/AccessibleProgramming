//
//  BlocksActivityController.swift
//  BlocksForAll
//
...
var activityBlocksStack = [Block]()

protocol activityBlockSelectionDelegate{
    func setSelectedBlocks(_ blocks:[Block])
    func unsetBlocks()
    func setParentViewController(_ myVC:UIViewController)
}

class ActivityViewController:  UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, activityBlockSelectionDelegate {
